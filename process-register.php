...
session_start();
include "koneksi.php";
//dapatkan data user dari form register.html
$user = [
    'nama' => $_POST['nama'],
...
//jika username sudah ada, maka return kembali ke halaman register.html.
if($row != null){
    ...
    $result = $stmt->get_result();
    var_dump($result);
    $_SESSION['message']  = 'Berhasil register.html ke dalam sistem. Silakan login dengan username dan password yang sudah dibuat.';
    header("Location: /register.html.php");
}
?>